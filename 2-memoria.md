...
Realizando calculos de manera manueal en las cuales tenemos 300 megabytes y 1gb que es igual a 1024 megabytes realizariamos la resta.

```
Memoria swap máxima = 1024-300= 724m
```
Mediante el comando docker inspect analizando tenemos los siguientes valores

```
Memoria swap máxima = 1073747824-314572800=  759175024
```
